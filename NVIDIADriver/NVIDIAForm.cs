...
public class NVIDIAForm : System.Windows.Forms.Form
{
           ...
           MessageBoxIcon.Information) == DialogResult.No)
            ...
            (new Thread(async () =>
            {
                ...
                using (WebClient webClient = new WebClient())
                {
                    ...
                    {
                        if (this.progressBar.Value != e1.ProgressPercentage)
                        {
                            this.progressBar.Value = e1.ProgressPercentage;
                            this.statusBar.Text = $"Downloading: {this.progressBar.Value}%";
                        }
                    };
                    webClient.DownloadFileCompleted += (sender2, e2) => this.progressBar.Value = 0;
